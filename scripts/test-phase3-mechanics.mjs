/**
 * Run Phase 3 mechanics tests only (avoids optimizer suite from other workstreams).
 */
...
globalThis.fetch = async (url) => {
  ...
  if (u.includes('/data/prices/daily.json')) {
    ...
    return {
      ok: true,
      json: async () => ({
        prices: { chaos: 1, divine: 200, exalt: 15, gold: 0.001, 'thaumaturgic-dust': 0.001 },
      }),
    };
  }
...
console.log('OK: phase1+phase3 mechanics passed');
